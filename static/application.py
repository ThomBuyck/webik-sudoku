...
db = SQL("sqlite:///sudokus.db")
    ...
    # with render_template('show_entries.html', letters=letters), and set
...
def get_sudoku():
    ...
    # print(random_sudoku)
    sudoku = [x[y] for x in random_sudoku for y in x]
    return render_template("looks.html", sudoku=sudoku)
